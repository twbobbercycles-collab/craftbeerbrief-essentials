...
const DATA_RESOURCES = [
  {
    ...
    url: 'https://www.beerinstitute.org/resources/annual-report/',
  },
  {
    icon: '📦',
    title: 'Monthly Taxable Removals',
    description: 'Monthly domestic beer shipment data tracked with TTB. Key indicator of overall beer market volume.',
    source: 'Beer Institute',
    url: 'https://www.beerinstitute.org/beer-serves-america/the-numbers/taxes-paid/',
  },
  {
    icon: '🌍',
    title: 'Beer Import / Export Data',
    description: 'Monthly US beer import and export volumes tracked with the US Department of Commerce.',
    source: 'Beer Institute',
    url: 'https://www.beerinstitute.org/beer-serves-america/the-numbers/import-export/',
  },
  {
    icon: '🥫',
    title: 'Packaging Mix Trends',
    description: 'Annual data on beer packaging trends — cans vs bottles vs draft.',
    source: 'Beer Institute',
    url: 'https://www.beerinstitute.org/beer-serves-america/the-numbers/packaging-mix/',
  },
  {
    icon: '🫗',
    title: 'Non-Alcohol Beer Trends',
    description: 'Growth data on the non-alcoholic beer category including market share trends.',
    source: 'Beer Institute',
    url: 'https://www.beerinstitute.org/resources/statistics/non-alcohol-beer-growth-trends/',
  },
  {
    icon: '🍺',
    title: 'Annual Production Report',
  ...
  {
    icon: '🏛️',
    title: 'TTB Statistical Data',
    description: 'Official TTB data on beer production, removals, and tax collections.',
    source: 'TTB',
    url: 'https://www.ttb.gov/beer/beer-stats',
  },
  {
    icon: '📈',
    title: 'NBWA Beer Purchasers Index',
    description: 'Monthly survey of beer distributor purchasing intentions — a leading indicator of market trends.',
    source: 'NBWA',
    url: 'https://www.nbwa.org/resources/beer-purchasers-index',
  },
  {
    icon: '📋',
    title: 'BA Benchmark Survey',
    description: 'Annual financial benchmarking for craft breweries: margins, labor costs, and revenue per barrel.',
    source: 'Brewers Association',
