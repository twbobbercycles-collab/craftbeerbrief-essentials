...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { error: daErr } = await svc.from('distribution_accounts').insert([
      ...
      { id: ids.distRetailer2, brewery_id: b, account_name: 'Independent Bottle Shop',     account_type: 'retailer', contact_name: 'Sarah Kim',    contact_email: 'sarah@indbottle.example',         contact_phone: '555-0202', payment_terms: 'net_15', is_active: true, address: '842 W Belmont Ave, Chicago, IL 60657',   notes: 'Craft-focused — prefers local and seasonal releases',        preferred_package_types: ['16oz Cans'],        contacts: [{ name: 'Sarah Kim',    email: 'sarah@indbottle.example',        phone: '555-0202', role: 'Owner',   is_primary: true }], pricing: [{ package_type: 'Can',               price_per_unit: 1.85   }] },
      { id: ids.distBar1,      brewery_id: b, account_name: 'Craft & Draft Bar',           account_type: 'bar',      contact_name: 'Dave Torres',  contact_email: 'dave@craftdraft.example',          contact_phone: '555-0203', payment_terms: 'cod',    is_active: true, address: '560 W Hubbard St, Chicago, IL 60654',    notes: 'Tap takeover opportunity in Q3 — follow up on keg returns', preferred_package_types: ['1/6 barrel keg'],  contacts: [{ name: 'Dave Torres',  email: 'dave@craftdraft.example',        phone: '555-0203', role: 'Manager', is_primary: true }], pricing: [{ package_type: 'Keg Sixth Barrel', price_per_unit: 140.00 }] },
